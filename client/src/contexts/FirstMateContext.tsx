    ...
    async (query: string): Promise<string> => {
      ...
      try {
        ...
        const historyEntry: FirstMateAskHistoryEntry = {
          ...
          relatedIssue: res.relatedIssue,
          suggestedFollowUp: res.suggestedFollowUp,
          applicablePrinciple: res.applicablePrinciple ?? null,
          distinctions: res.distinctions ?? null,
          conditions: res.conditions ?? null,
          missingFacts: res.missingFacts ?? null,
          suggestedClientWording: res.suggestedClientWording ?? null,
          advocateNextAction: res.advocateNextAction ?? null,
          provenance: (res.provenance as any) || "AI: FALLBACK",
