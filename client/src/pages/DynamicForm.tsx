...
import { CheckCircle2, ChevronRight, ChevronLeft, User, GraduationCap, Heart, Calendar, ExternalLink, Loader2 } from "lucide-react";
              ...
              <div className="text-center space-y-4 py-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm mt-1">
                    Book your initial consultation at a time that works best for you.
                  </p>
                </div>
                <Button
