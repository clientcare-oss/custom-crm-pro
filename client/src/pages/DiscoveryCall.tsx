    ...
    <div className="min-h-screen bg-[#071422] text-white">
      ...
      <div className="px-6 pb-4">
        <div className="rounded-xl bg-[#0d1f33] border border-white/10 p-4">
                    ...
                    {editingStepId === step.id ? (
                      <div className="flex items-center gap-1">
                        <input
                          ...
                          className="text-xs bg-[#071422] border border-amber-400 rounded px-2 py-1 text-white w-28 outline-none"
                        />
                      </div>
                    ) : (
                      <button
                        ...
                        title="Click to mark complete · Double-click to rename"
          ...
          <p className="text-[10px] text-white/30 mt-2">Click a step to mark complete · Double-click to rename</p>
        </div>
      </div>
