...
export const PAGE_IDS: Record<string, PageIdInfo> = {
  ...
  "/portal/student-selection":        { id: "PG-027-S04", name: "Portal: Student Selection", category: "Portal Stage" },
  "/portal/support-selection":        { id: "PG-027-S05", name: "Portal: Support Level Selection", category: "Portal Stage" },
  "/portal/checkout":                 { id: "PG-027-S06", name: "Portal: Payment & Retainer", category: "Portal Stage" },
  "/portal/welcome":                  { id: "PG-027-S07", name: "Portal: Welcome to Waypoint", category: "Portal Stage" },
  "/portal/agreements":               { id: "PG-027-S08", name: "Portal: Advocacy Agreements", category: "Portal Stage" },
  "/portal/student-setup":            { id: "PG-027-S09", name: "Portal: Student Setup Profile", category: "Portal Stage" },
  "/portal/document-upload":          { id: "PG-027-S10", name: "Portal: Document Upload", category: "Portal Stage" },
  "/portal/advocacy-intake":          { id: "PG-027-S11", name: "Portal: Advocacy Detailed Intake", category: "Portal Stage" },
