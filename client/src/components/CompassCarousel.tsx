...
const SECTIONS = [
  {
    ...
    bg: "bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/60 dark:to-blue-900/40",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-950/60 dark:to-violet-900/40",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/60 dark:to-emerald-900/40",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-950/60 dark:to-amber-900/40",
  ...
  },
  {
    ...
    bg: "bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-950/60 dark:to-rose-900/40",
    ...
    <div className="select-none">
      ...
      >
        ...
        <div className={`flex items-center gap-2.5 px-5 pt-5 pb-3`}>
          <div className={`flex h-8 w-8 items-center justify-center rounded-full bg-white/60 dark:bg-black/20 shadow-sm`}>
        ...
        {current > 0 && (
          <button
            onClick={prev}
            aria-label="Previous"
            className={`absolute left-2 top-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 dark:bg-black/40 shadow-md border border-border/40 text-foreground hover:bg-white dark:hover:bg-black/60 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 sm:opacity-70 sm:hover:opacity-100`}
          >
        ...
        {current < slides.length - 1 && (
          <button
            onClick={next}
            aria-label="Next"
            className={`absolute right-2 top-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-white/80 dark:bg-black/40 shadow-md border border-border/40 text-foreground hover:bg-white dark:hover:bg-black/60 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 sm:opacity-70 sm:hover:opacity-100`}
          >
