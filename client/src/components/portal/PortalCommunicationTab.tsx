...
export default function PortalCommunicationTab({
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto space-y-6">
      ...
      {/* Message Thread */}
      <Card className="border-slate-800 bg-[#0A1628]/90 text-slate-100 shadow-xl min-h-[350px] flex flex-col justify-between">
        ...
        {/* Message Input Form */}
        <div className="p-3 border-t border-slate-800 bg-slate-900/60 rounded-b-xl">
