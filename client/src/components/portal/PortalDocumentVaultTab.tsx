...
export default function PortalDocumentVaultTab({
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-12 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-1">
        ...
        <div className="flex items-center gap-2.5 self-start md:self-auto">
          ...
          <Button
            ...
            className="gap-2 text-xs font-bold bg-amber-400 hover:bg-amber-500 text-[#071422] shadow-md shadow-amber-400/20 h-9 px-4 rounded-xl transition-all"
          >
      ...
      <div className="rounded-2xl border border-white/10 bg-[#071422]/90 backdrop-blur-md p-5 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-10 h-10 bg-[#071422]/70 border-white/15 text-white placeholder:text-white/40 text-xs rounded-xl focus-visible:ring-amber-400"
          />
          {searchQuery && (
            <button
        ...
        <Select value={selectedWorkspaceFilter} onValueChange={setSelectedWorkspaceFilter}>
          <SelectTrigger className="w-full sm:w-[150px] h-10 bg-[#071422]/70 border-white/15 text-white text-xs rounded-xl">
            <div className="flex items-center gap-2">
              <Filter className="w-3.5 h-3.5 text-amber-400" />
              <SelectValue placeholder="Filter" />
            </div>
          </SelectTrigger>
          <SelectContent className="bg-[#071422] border-white/15 text-white">
        ...
        <Select value={sortBy} onValueChange={(v) => setSortBy(v as any)}>
          <SelectTrigger className="w-full sm:w-[140px] h-10 bg-[#071422]/70 border-white/15 text-white text-xs rounded-xl">
            <div className="flex items-center gap-2">
        ...
        {/* View Toggle */}
        <div className="flex items-center p-1 rounded-xl bg-[#071422]/80 border border-white/15 self-end sm:self-auto shrink-0">
          <button
            onClick={() => setViewMode("grid")}
            className={`p-1.5 rounded-lg transition-colors ${
              viewMode === "grid"
                ? "bg-amber-400 text-[#071422] shadow-sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-3">
            {workspaces.map((ws) => (
              <Card
                ...
                className="group relative p-4 rounded-2xl bg-[#071422]/70 hover:bg-[#0b1c30] border-white/10 hover:border-amber-400/50 transition-all duration-200 cursor-pointer flex flex-col items-center text-center justify-between min-h-[125px] shadow-lg hover:shadow-amber-400/10"
              >
            ...
            <Card
              ...
              className="group p-4 rounded-2xl bg-[#071422]/40 hover:bg-[#0b1c30]/70 border border-dashed border-white/20 hover:border-amber-400/60 transition-all duration-200 cursor-pointer flex flex-col items-center text-center justify-center min-h-[125px]"
            >
        ...
        <div className="lg:col-span-6 space-y-3.5">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#071422]/80 backdrop-blur-md p-3.5 space-y-2 shadow-xl">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#071422]/80 backdrop-blur-md p-5 space-y-4 shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3.5">
          ...
          <Card
            ...
            className="group p-4 rounded-2xl bg-[#071422]/40 hover:bg-[#0b1c30]/70 border border-dashed border-white/20 hover:border-amber-400/60 transition-all cursor-pointer flex flex-col items-center text-center justify-center min-h-[140px]"
          >
            <div className="w-9 h-9 rounded-full bg-white/5 group-hover:bg-amber-400/20 border border-white/10 group-hover:border-amber-400/40 flex items-center justify-center text-white/60 group-hover:text-amber-300 mb-2 transition-all">
              <Plus className="w-4 h-4" />
            </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-[#071422] to-[#091b30] p-5 md:p-6 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-5">
      ...
      <Dialog open={showHowItWorks} onOpenChange={setShowHowItWorks}>
        <DialogContent className="max-w-md bg-[#071422] border-white/15 text-white rounded-2xl p-6">
          <DialogHeader>
          ...
          <DialogFooter>
            <Button
              ...
              className="w-full bg-amber-400 hover:bg-amber-500 text-[#071422] font-bold text-xs rounded-xl"
            >
              Got It
            </Button>
          </DialogFooter>
      ...
      <Dialog open={showSecurityModal} onOpenChange={setShowSecurityModal}>
        <DialogContent className="max-w-lg bg-[#071422] border-white/15 text-white rounded-2xl p-6">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold flex items-center gap-2 text-white">
              <ShieldCheck className="w-5 h-5 text-emerald-400" />
        ...
        <DialogContent className="max-w-md bg-[#071422] border-white/15 text-white rounded-2xl p-6">
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              ...
              className="bg-amber-400 hover:bg-amber-500 text-[#071422] font-bold text-xs rounded-xl"
            >
              Create Workspace
            </Button>
          </DialogFooter>
          ...
          <DialogContent className="max-w-lg bg-[#071422] border-white/15 text-white rounded-2xl p-6">
            ...
            <DialogFooter className="flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                className="bg-amber-400 hover:bg-amber-500 text-[#071422] font-bold text-xs rounded-xl gap-1.5"
              >
      ...
      <Dialog open={!!activeWorkspaceModal} onOpenChange={(open) => !open && setActiveWorkspaceModal(null)}>
        {activeWorkspaceModal && (
          <DialogContent className="max-w-2xl bg-[#071422] border-white/15 text-white rounded-2xl p-6">
            <DialogHeader>
              <div className="flex items-center gap-2">
            ...
            {documents
              ...
              .map((doc) => (
                ...
                >
                  ...
                  <Button size="sm" className="bg-amber-400 hover:bg-amber-500 text-[#071422] text-xs font-bold h-7 px-2.5 rounded-lg">
                    Pin
                  </Button>
                </div>
              ))}
