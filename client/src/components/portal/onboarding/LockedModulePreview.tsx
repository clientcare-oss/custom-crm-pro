...
export function LockedModulePreview({
  ...
  return (
    <div className="p-6 md:p-10 lg:p-12 space-y-8 max-w-4xl mx-auto animate-in fade-in duration-300">
      ...
      <Card className="border-white/15 bg-gradient-to-br from-white/[0.04] via-[#0a1828] to-[#071422] p-6 md:p-8 rounded-2xl space-y-6 shadow-xl">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-white/10">
          ...
          <Button
            ...
            className="gap-2 bg-amber-400 hover:bg-amber-500 text-[#071422] font-bold text-xs px-5 shadow-md"
          >
            {config.cta}
