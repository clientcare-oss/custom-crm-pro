...
export default function CaseCompassCard({ caseId, isAdminView = false }: CaseCompassCardProps) {
  ...
  const [bgSettings, setBgSettings] = useState({
    ...
    bgOpacity: 74 // Balanced deep nautical navy overlay
  });
    ...
    <div className="space-y-3">
      <Card className="rounded-2xl border border-blue-900/40 shadow-2xl overflow-hidden bg-[#06172F] text-white flex flex-col p-0 gap-0">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `linear-gradient(rgba(6, 23, 47, ${(bgSettings.bgOpacity ?? 74) / 100}), rgba(0, 8, 33, ${((bgSettings.bgOpacity ?? 74) + 4) / 100})), url('/compass-bg.jpg')`,
