...
export function PcsPasteReplaceModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-3xl bg-[#07182E] border border-[#1A4578] text-slate-100 shadow-2xl p-6">
        ...
        <div className="space-y-3 pt-2">
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className="h-7 text-[11px] border-slate-700 bg-slate-900/60 text-slate-300 hover:text-white gap-1 cursor-pointer"
            >
          ...
          <Textarea
            ...
            className="min-h-[180px] bg-[#051324] border-[#183D68] text-slate-100 placeholder:text-slate-500 text-xs sm:text-sm font-sans leading-relaxed p-3.5 rounded-xl focus:ring-2 focus:ring-[#F5B544]/40"
          />
        ...
        {showPreview && (
          <div className="mt-3 p-3.5 rounded-xl bg-[#040E1B] border border-[#163860] space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
              <div className="p-3 rounded-lg bg-slate-900/80 border border-slate-800">
                ...
                <p className="text-slate-300 line-clamp-6 whitespace-pre-wrap font-sans">
              ...
              <div className="p-3 rounded-lg bg-blue-950/40 border border-blue-800/40">
                ...
                <p className="text-blue-100 line-clamp-6 whitespace-pre-wrap font-sans">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-[#183E6C] mt-2">
          <Button
            ...
            className="text-xs text-blue-300 hover:text-white hover:bg-slate-800/60 gap-1.5 cursor-pointer disabled:opacity-40"
          >
            <Eye className="w-3.5 h-3.5 text-blue-400" />
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              disabled={!pastedText.trim()}
              className="text-xs bg-[#F5B544] hover:bg-[#F5B544]/90 text-slate-950 font-bold gap-1.5 shadow-md cursor-pointer disabled:opacity-50"
            >
