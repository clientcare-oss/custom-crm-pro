...
Waypoint Advocates Team`;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-2xl bg-[#07182E] border border-[#1A4578] text-slate-100 shadow-2xl p-6">
        <DialogHeader className="space-y-1.5 pb-3 border-b border-[#183E6C]">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input
                ...
                className="h-8 text-xs bg-[#051324] border-[#183D68] text-slate-100 focus:ring-1 focus:ring-blue-400"
              />
            </div>
            <div className="space-y-1">
          ...
          <div className="space-y-1">
            ...
            <Textarea
              ...
              rows={2}
              className="text-xs bg-[#051324] border-[#183D68] text-slate-200 focus:ring-1 focus:ring-blue-400 leading-relaxed"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {isEditingBody ? (
              <Textarea
                ...
                className="min-h-[160px] text-xs font-sans bg-[#040E1B] border-[#1A4578] text-slate-100 p-3 rounded-lg leading-relaxed focus:ring-1 focus:ring-blue-400"
              />
            ) : (
              <div className="max-h-[180px] overflow-y-auto p-3.5 rounded-lg bg-[#040E1B] border border-[#163860] text-xs text-slate-200 whitespace-pre-wrap leading-relaxed font-sans">
          ...
          <div className="p-2.5 rounded-lg bg-amber-500/10 border border-amber-500/20 text-[11px] text-amber-300 flex items-start gap-2">
            <ShieldCheck className="w-4 h-4 text-[#F5B544] flex-shrink-0 mt-0.5" />
            <span>
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-between pt-4 border-t border-[#183E6C] mt-2">
          <Button
            type="button"
            variant="outline"
            size="sm"
            onClick={handleCopyEmail}
            className="text-xs border-slate-700 bg-slate-900/60 text-slate-300 hover:text-white gap-1.5 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="text-xs border-slate-700 bg-slate-900 text-slate-300 hover:bg-slate-800 cursor-pointer"
            >
              Cancel
            </Button>
            <Button
              ...
              disabled={isSending}
              className="text-xs bg-blue-600 hover:bg-blue-500 text-white font-bold gap-1.5 shadow-md cursor-pointer disabled:opacity-50"
            >
